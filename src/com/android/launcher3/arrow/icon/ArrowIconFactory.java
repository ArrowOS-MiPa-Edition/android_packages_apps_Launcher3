 ...
 */
package com.android.launcher3.arrow.icon;
...
public class ArrowIconFactory extends BaseIconFactory {
    ...
    public ArrowIconFactory(Context context, int fillResIconDpi, int iconBitmapSize) {
